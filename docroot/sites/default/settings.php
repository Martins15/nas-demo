...
$databases = array("default" => array ("default" => array ("database" => "audubon", "username" => "audubon", "password" => "audubon", "host" => "127.0.0.1", "port" => "", "driver" => "mysql", "prefix" => "", ), ), );
$conf["memcache_key_prefix"] = "audubon";

...
$conf['cache_default_class'] = 'MemCacheDrupal';		+$conf["cache_default_class"] = "MemCacheDrupal";
$conf['cache_class_cache_form'] = 'DrupalDatabaseCache';		+$databases = array("default" => array ("default" => array ("database" => "drupal", "username" => "root", "password" => "root", "host" => "127.0.0.1", "port" => "", "driver" => "mysql", "prefix" => "", ), ), );
$conf['cache_class_cache_page'] = 'DrupalFakeCache';		+$conf["memcache_key_prefix"] = "drupal";
$conf['https'] = TRUE;		+$conf["pp_environment"] = "default";

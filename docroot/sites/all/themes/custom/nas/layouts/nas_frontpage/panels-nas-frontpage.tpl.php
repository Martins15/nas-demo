 ...
 */
?>
<section class="curtain" style="background-color: <?php print !empty($bg_color) ? $bg_color : '#fff'; ?>; background-image: url(<?php print !empty($frontpage_backgroundimage) ? $frontpage_backgroundimage : ''; ?>)">

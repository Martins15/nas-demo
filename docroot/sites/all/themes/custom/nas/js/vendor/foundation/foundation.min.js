...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.clearing = {
    ...
    open : function ($image, current, target) {
      ...
      // Prevent default action on close icon click.
      container.find(this.settings.close_selectors).click(function (e) {
        e.preventDefault();
      });
      ...
      function cb (image) {
        var $image = $(image);
        // Find image width and ration to set correct position for close button
        var width = $image[0].width;
        var imageRatio = $image[0].height / width;

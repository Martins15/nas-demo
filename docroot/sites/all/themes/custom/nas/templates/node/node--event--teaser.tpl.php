 ...
 *
 * Custom variables:
 * - $start_date_day: The day when event begins.
 * - $start_date_month: The month when event begins.
...
<div class="event-teaser">
  ...
  <div class="tiny-8 small-9 columns event-content">
    ...
    <?php if (!empty($origin_site_events_link) || !empty($event_location)): ?>
    <p><?php print $origin_site_events_link . ' ' . $event_location; ?></p>
    <?php endif; ?>

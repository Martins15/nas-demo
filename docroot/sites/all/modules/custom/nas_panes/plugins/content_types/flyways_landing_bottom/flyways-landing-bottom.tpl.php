...
<div class="flyway-slides contextual-links-region">
  ...
  <div class="flyway-slides-container">
    <?php for ($i = 1; $i <= NAS_FLYWAYS_NUMBER; $i++): ?>
			<div id="<?php print $flyway[$i]['name_id']; ?>-slide" class="flyway-slide clearfix<?php if ($i == 1 ): ?> current<?php endif; ?>">
  ...
  <div class="flyways-slides-dots">
	  <?php for ($i = 1; $i <= NAS_FLYWAYS_NUMBER; $i++): ?>
	    <a href="#<?php print $flyway[$i]['name_id']; ?>-slide"><span class="dot<?php if ($i == 1): ?> active<?php endif; ?>"></span></a>
	  <?php endfor; ?>
	</div>
</div>

 ...
 */
?>
<div class="social-sharing<?php print !empty($contextual_links) ? ' contextual-links-region' : ''; ?>">
  <?php print $contextual_links; ?>
  <span class="social-sharing-caption small"><?php print $caption; ?></span>
  <a class="social-sharing-icon blue" target="_blank" href="<?php print $twitter_url; ?>"><i class="icon-twitter"></i></a>

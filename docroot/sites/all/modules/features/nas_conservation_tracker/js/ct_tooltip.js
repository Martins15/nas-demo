...
(function($) {
   ...
   */
  d3.ct_tooltip = function(tipjar, txt, h, w) {
    ...
    var path = d3.ct_tooltip.tooltipPath(tooltip);
    for (var x = 2; x >= 0; x--) {
      img.append('path')
        .attr("d", path)
  ...
  d3.ct_tooltip.tooltipPath = function (tooltip) {
    tooltip = $.extend(true, {}, d3.ct_tooltip.tooltipDefault, tooltip);
    return "M0,0"

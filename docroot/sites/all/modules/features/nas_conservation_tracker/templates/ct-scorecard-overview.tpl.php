        ...
        <div ng-repeat="(key, value) in tab.settings.tabs">
            <div class="bird-page body-item" ng-cloak  ng-class="{'active': isActive === value}">
                ...
                <div class="title-wrap">
                    <div class="title-wrap__title columns tiny-10"><h3>{{tab.settings.overview.title}}</h3></div>
...
<!--            <div class="video-wrap columns large-4">-->
<!--                <div class="video-wrap__item help-img-full">-->
<!--                    <img src={{actions.data.settings.actions.thumbnail}} alt="">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="bird-page body-item" ng-cloak-->
...
<!--            <div class="video-wrap columns large-4">-->
<!--                <div class="video-wrap__item help-img-full">-->
<!--                    <img src={{threats.data.settings.threats.thumbnail}} alt="">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="bird-page body-item" ng-cloak-->
...
<!--            <div class="video-wrap columns large-4">-->
<!--                <div class="video-wrap__item help-img-full">-->
<!--                    <img src={{partners.data.settings.partners.thumbnail}} alt="">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
    </div>

...
If you are using image styles with images pulled from NetX please set image_allow_insecure_derivatives to TRUE. This can be done with drush command 'drush vset image_allow_insecure_derivatives TRUE'.

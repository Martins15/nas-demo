...
<div class="hero light-text dark-gradient">
  <div class="hero-image">
    <img src="<?php print base_path() . path_to_theme() . '/img/hero-img-9-mobile.jpg'; ?>" alt="" class="hide-for-medium hide-for-large hide-for-xlarge">
    <img src="<?php print base_path() . path_to_theme() . '/img/hero-img-9.jpg'; ?>" alt="" class="hide-for-tiny hide-for-small">
  </div>
  <div class="row">
      ...
      <div class="hero-card-column column hide-for-small hide-for-tiny medium-4 large-3">
        <figure class="bird-card">
          <div class="bird-card-illustration">
            <a href="#"><img src="<?php print base_path() . path_to_theme() . '/img/bird-7.jpg'; ?>" alt=""></a>
          </div>

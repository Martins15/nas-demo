...
<section class="global-content with-padding">
  ...
  <div class="boa-bird-card-set bg-boa-bejge">
    <div class="row section-header space-top">
      <div class="columns">
        <h2 class="thin">Explore by family</h2>
      </div>
      <div class="columns">
        <ul class="section-nav inline-list">
          <li><a href="#" id="by-family" class="cta">View the plates in chronological order</a></li>
          <li><a href="#" id="by-alphabetical" class="cta">Alphabetically</a></li>
          <li><a href="#" id="by-state" class="cta">State Birds</a></li>
        </ul>
      </div>
    </div>
    <div class="row boa-bird-card-container">
      <div class="columns tiny-6 medium-4 large-3">
        <div class="boa-bird-card">
          <img src="../../img/boa-bird-1.jpg" alt="" />
    ...
    <div class="row boa-load-more">
      <div class="column">
        <a class="button large load-more">
          <i class="load-more-icon icon-spin-widdershins"></i>

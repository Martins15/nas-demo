...
<header class="global-header transparent light-bg dark-text">
  <section class="dont-miss strip-nav small">
    <div class="row">
      <div class="columns">
        <ul class="inline-list" style="width: 1011px; transition: 0ms cubic-bezier(0.1, 0.57, 0.1, 1); -webkit-transition: 0ms cubic-bezier(0.1, 0.57, 0.1, 1); transform: translate(0px, 0px) translateZ(0px);">
          <li class="dont-miss-header strip-nav-header"><span>Don’t Miss</span></li>
          <li><a href="#">Photography</a></li>
          <li><a href="#">Galveston Bay Oil Spill</a></li>
          <li><a href="#"><i class="icon-video"></i> Snowy Owl Webcam</a></li>
          <li><a href="#">Toyota TogetherGreen</a></li>
          <li><a href="#">Wind Farms</a></li>
          <li><a href="#">Adopt a Bird</a></li>
          <li><a href="#">Piping Plover</a></li>
        </ul>
      </div>
    </div>
  </section>
          ...
          <ul class="primary-nav inline-list">
            <li class="primary-nav-item">
              ...
              <ul class="primary-sub-nav">
                ...
                <li class="primary-sub-nav-item"><a class="primary-sub-nav-link" href="#">Featured Events</a></li>
                <li class="primary-sub-nav-item"><a class="primary-sub-nav-link" href="#">Audubon Climate Watch</a></li>
              </ul>
            </li>
            <li class="primary-nav-item">
              ...
              <ul class="primary-sub-nav">
                ...
                <li class="primary-sub-nav-item"><a class="primary-sub-nav-link" href="#">Map Stories</a></li>
            ...
            <li class="current-parent current primary-nav-item">
              <a class="current-parent current primary-nav-toggler" href="index.html">Birds</a>
              <ul class="primary-sub-nav">
                <li class="current-parent current primary-sub-nav-item primary-sub-nav-index"><a class="current-parent current primary-sub-nav-link" href="index.html">Birds Home</a></li>
                <li class="primary-sub-nav-item"><a class="primary-sub-nav-link" href="#">Flyways</a></li>
                <li class="primary-sub-nav-item"><a class="primary-sub-nav-link" href="guide/index.html">Bird Guide</a></li>
                ...
                <li class="primary-sub-nav-item"><a class="primary-sub-nav-link" href="#">Birds of America</a></li>
              </ul>
            </li>
            <li class="primary-nav-item">
            ...
            <li class="primary-nav-item"><a href="../about/index.html">About<span class="extra-nav-copy"> Us</span></a></li>
